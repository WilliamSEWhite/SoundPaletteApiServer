...
VALUES
    ...
    (4, 'Excited to finally share this track with everyone!', NULL, '#720O9B7', '#000000'),
    ...
    (13, 'Looking for a vocalist to collaborate with on my next track.', NULL, '#7209B7', '#000000'),
    (14, 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3', NULL, NULL, NULL),
    (15, 'image19.png', NULL, NULL, NULL),
    (16, 'Blending jazz influences into my latest piece.', NULL, '#7209B7', '#FFFFFF'),
